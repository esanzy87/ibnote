...
Source of truth: `docs/features/006_record_revisit_convenience_pack/spec.md`
Companion docs:
- `docs/features/006_record_revisit_convenience_pack/prd.md`
...
- Evidence:
  ...
  - sign-off/debate conclusion is now recorded as required governance evidence before worker launch
- Scope:
