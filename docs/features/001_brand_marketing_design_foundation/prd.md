...
If older bootstrap text conflicts with closeout truth, use the latest closeout snapshot in `docs/features/000_bootstrap/todo.md` and `NIGHT_RUN_REPORT.md` as canonical.
...
1. Product clarity criteria pass on in-scope routes via VR-01..VR-08 in `docs/features/001_brand_marketing_design_foundation/spec.md`.
