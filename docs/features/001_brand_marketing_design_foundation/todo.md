...
Source of truth: `docs/features/001_brand_marketing_design_foundation/spec.md`
Companion docs:
- `docs/features/001_brand_marketing_design_foundation/prd.md`
...
- QA:
  - no contradiction with 000 docs and run reports
...
- Result:
  ...
  - package closeout truth is synced across `todo.md`, `BLACKBOARD`, and `NIGHT_RUN_REPORT.md`
