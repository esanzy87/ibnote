...
- Package 007 should remain open at `C-01`, but automatic unattended closeout relaunches should stay frozen until the auth/protected-route behavior is explicitly debugged.
...
- Package 007 should remain open at `C-01`, but automatic unattended closeout relaunches should stay frozen until the runtime asset failure is explicitly debugged.
...
- Package 007 should remain open at `C-01`, but automatic unattended closeout relaunches should be frozen until a deeper runtime-debug pass is explicitly resumed.
