...
Source of truth: `docs/features/007_micro_usability_and_empty_state_polish/prd.md`
Companion docs:
- `docs/features/007_micro_usability_and_empty_state_polish/todo.md`
...
- 007 must stay intentionally narrow, deterministic, and unattended-friendly.
