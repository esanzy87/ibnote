...
Source of truth: `docs/features/010_stitch_ui_adoption_foundation/prd.md`
Companions:
- `docs/features/010_stitch_ui_adoption_foundation/mismatch_ledger.md`
...
6. Could an unattended coding worker execute the plan without guessing what to keep versus trim?
