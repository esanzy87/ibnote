...
- unattended progress may over-select safe polish while under-investing in leverage across the core parent loop
...
- #4 violates anti-drift guardrails and is too broad for unattended-safe follow-on work
