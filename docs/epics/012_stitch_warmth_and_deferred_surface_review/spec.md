...
Source of truth: `docs/epics/012_stitch_warmth_and_deferred_surface_review/prd.md`
Companions:
- `docs/epics/012_stitch_warmth_and_deferred_surface_review/reintegration_ledger.md`
- `docs/epics/012_stitch_warmth_and_deferred_surface_review/signoff_briefing.md`
...
- `docs/epics/010_stitch_ui_adoption_foundation/carry_forward_notes.md`
