...
- Status: accepted
- Context: reset can be made discoverable in multiple valid ways, but implementation becomes safer when the UX shape is fixed up front.
...
- Consequences:
  ...
  - implementation has less room to invent modal/inline complexity
