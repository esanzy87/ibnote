...
Source of truth: `docs/epics/000_bootstrap/spec.md`
Companion docs:
- `docs/epics/000_bootstrap/prd.md`
- `docs/epics/000_bootstrap/adr.md`
- `docs/epics/000_bootstrap/risk_analysis.md`
...
- the launch gate in `docs/epics/000_bootstrap/spec.md` is satisfied
