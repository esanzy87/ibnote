...
If older bootstrap text conflicts with closeout truth, use `docs/epics/000_bootstrap/todo.md` current snapshot and current control-plane/docpack truth as canonical.
