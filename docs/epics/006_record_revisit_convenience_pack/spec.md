...
Status: Hardened draft - sign-off/debate pass recorded, ready-implementation when work begins
Source of truth: `docs/epics/006_record_revisit_convenience_pack/prd.md`
Companion docs:
- `docs/epics/006_record_revisit_convenience_pack/todo.md`
...
- for the initial implementation pass, assume `/my/records` only unless a concrete source/runtime finding during implementation proves that a tiny `/my/records/[id]` companion pass is needed to keep revisit wording or re-entry truth internally consistent
...
| VR-05 | Governance complete | sign-off/debate conclusion is recorded before or at implementation start, and closeout risk disposition is explicit | sign-off note |
